VoluntariandoMe::Application.configure do
...
ENV['PATH']='/usr/local/rvm/gems/ruby-1.9.3-p194@voluntariando-me/bin:$PATH'
ENV['MY_RUBY_HOME']='/usr/local/rvm/wrappers/ruby-1.9.3-p194@voluntariando-me/ruby'
